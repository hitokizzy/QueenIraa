...
from QueenIraa.modules.helper_funcs.decorators import queencmd, kigcallback, queenmsg
...
@queencmd(command='start', pass_args=True)
...
@queenmsg(Filters.status_update.migrate)
...
def main():
    ...
    if WEBHOOK:
        ...
        log.info(f"iraa started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
        iraaINIT.bot_id = dispatcher.bot.id
...
if __name__ == "__main__":
    log.info("[Queen Iraa] Successfully loaded modules: " + str(ALL_MODULES))
