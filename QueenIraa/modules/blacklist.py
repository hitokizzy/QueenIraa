...
from QueenIraa.modules.sql.approve_sql import is_approved
import QueenIraa.modules.sql.blacklist_sql as sql
from QueenIraa import log, dispatcher
from QueenIraa.modules.helper_funcs.chat_status import user_admin as u_admin, user_not_admin
...
from QueenIraa.modules.helper_funcs.decorators import queencmd, queenmsg
...
@queencmd(command="blacklist", pass_args=True, admin_ok=True)
@u_admin
@typing_action
...
@queencmd(command="addblacklist", pass_args=True)
...
@queencmd(command="unblacklist", pass_args=True)
@user_admin(AdminPerms.CAN_DELETE_MESSAGES)
@typing_action
...
@queencmd(command="blacklistmode", pass_args=True)
@loggable
...
@queenmsg(((Filters.text | Filters.command | Filters.sticker | Filters.photo) & Filters.chat_type.groups), group=BLACKLIST_GROUP)
@user_not_admin
