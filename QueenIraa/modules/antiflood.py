...
from QueenIraa import GEEZRAM_USERS, WHITELIST_USERS, dispatcher
from QueenIraa.modules.sql.approve_sql import is_approved
from QueenIraa.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    connection_status,
    is_user_admin,
...
@queenmsg((Filters.all & ~Filters.status_update & Filters.chat_type.groups), group=FLOOD_GROUP)
@connection_status
@loggable
...
@queencmd(command='setflood', pass_args=True, filters=Filters.chat_type.groups)
@connection_status
...
@queencmd(command="flood", filters=Filters.chat_type.groups)
@connection_status
...
@queencmd(command="setfloodmode", pass_args=True, filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
