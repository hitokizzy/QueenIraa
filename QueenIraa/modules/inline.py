...
from QueenIraa.modules.helper_funcs.misc import article
from QueenIraa.modules.helper_funcs.decorators import queeninline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on iraa",
            "description": "Look up a Telegram account in iraa database",
            "message_text": "Click the button below to look up a person in iraa database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about iraa",
            "message_text": "Click the button below to get to know about iraa.",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".about ",
        },
        {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        nation_level_present = True
    elif user.id in GEEZRAM_USERS:
        text += f"\n\nThe Nation level of this person is GEEZRAM"
        nation_level_present = True
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About iraa (@{context.bot.username})",
