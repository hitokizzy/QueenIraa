...
from QueenIraa import LASTFM_API_KEY
from QueenIraa.modules.helper_funcs.decorators import queencmd
import QueenIraa.modules.sql.last_fm_sql as sql

@queencmd(command='setuser')
