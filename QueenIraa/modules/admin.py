...
@queencmd(command="promote", can_disable=False)
@connection_status
@bot_admin
@can_promote
...
@queencmd(command="demote", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
"""
@queencmd(command="admincache", can_disable=False)
@u_admin
...
@queencmd(command="title", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
@queencmd(command="pin", can_disable=False)
@bot_admin
@can_pin
...
@queencmd(command="unpin", can_disable=False)
@bot_admin
@can_pin
@user_admin(AdminPerms.CAN_PIN_MESSAGES)
@loggable
...
@queencmd(command="invitelink", can_disable=False)
@bot_admin
