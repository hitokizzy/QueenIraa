...
from QueenIraa.modules.helper_funcs.extraction import (
    extract_user,
    extract_unt_fedban,
    extract_user_fban,
)
...
from QueenIraa.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
from QueenIraa.modules.helper_funcs.decorators import queencmd, kigcallback
...
@typing_action
@queencmd(command='delfed', pass_args=True)
...
@typing_action
@queencmd(command='chatfed', pass_args=True)
...
@typing_action
@queencmd(command='joinfed', pass_args=True)
...
@typing_action
@queencmd(command='fpromote', pass_args=True)
...
@typing_action
@queencmd(command='fdemote', pass_args=True)
...
@typing_action
@queencmd(command='fedinfo', pass_args=True)
...
@typing_action
@queencmd(command='fedadmins', pass_args=True)
...
@typing_action
@queencmd(command=['fban', 'fedban'], pass_args=True)
...
@typing_action
@queencmd(command=['unfban', 'rmfedban'], pass_args=True)
...
@typing_action
@queencmd(command='frules', pass_args=True)
...
@typing_action
@queencmd(command='fbroadcast', pass_args=True)
...
@queencmd(command='fbanlist', pass_args=True, pass_chat_data=True)
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "queen_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="queen_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "queen_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="queen_fbanned_users.csv",
...
@typing_action
@queencmd(command='fednotif', pass_args=True)
...
@typing_action
@queencmd(command='fedchats', pass_args=True)
...
@typing_action
@queencmd(command='importfbans', pass_args=True, pass_chat_data=True)
...
@typing_action
@queencmd(command='fbanstat', pass_args=True)
...
@typing_action
@queencmd(command='setfedlog', pass_args=True)
...
@typing_action
@queencmd(command='unsetfedlog', pass_args=True)
...
@typing_action
@queencmd('subfed', pass_args=True)
...
@typing_action
@queencmd(command='unsubfed', pass_args=True)
...
@typing_action
@queencmd(command='fedsubs', pass_args=True)
...
@typing_action
@queencmd(command='myfeds', pass_args=True)
