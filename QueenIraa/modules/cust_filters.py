...
from QueenIraa import dispatcher, log, SUDO_USERS
...
from QueenIraa.modules.helper_funcs.misc import build_keyboard_parser
from QueenIraa.modules.helper_funcs.msg_types import get_filter_type
from QueenIraa.modules.helper_funcs.string_handling import (
    split_quotes,
...
from QueenIraa.modules.helper_funcs.alternate import send_message, typing_action
from QueenIraa.modules.helper_funcs.decorators import queencmd, queenmsg, kigcallback
...
@typing_action
@queencmd(command='filters', admin_ok=True)
...
@queencmd(command='filter', run_async=False)
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@queencmd(command='stop', run_async=False)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@typing_action
...
@queenmsg((CustomFilters.has_text & ~Filters.update.edited_message))
...
@queencmd(command="removeallfilters", filters=Filters.chat_type.groups)
