...
import QueenIraa.modules.sql.approve_sql as sql
from QueenIraa import SUDO_USERS
from QueenIraa.modules.helper_funcs.chat_status import user_admin as u_admin
...
@queencmd(command='approve', filters=Filters.chat_type.groups)
@loggable
...
@queencmd(command='unapprove', filters=Filters.chat_type.groups)
@loggable
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@queencmd(command='approved', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@queencmd(command='approval', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@queencmd(command='unapproveall', filters=Filters.chat_type.groups)
