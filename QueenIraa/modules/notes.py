...
from QueenIraa import log, dispatcher, SUDO_USERS
from QueenIraa.modules.helper_funcs.chat_status import connection_status
...
from QueenIraa.modules.helper_funcs.handlers import MessageHandlerChecker
from QueenIraa.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
...
@queenmsg((Filters.regex(r"^#[^\s]+")), group=-14)
@connection_status
...
@queenmsg((Filters.regex(r"^/\d+$")), group=-16)
@connection_status
...
@queencmd(command='removeallnotes')
