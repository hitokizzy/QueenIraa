...
@queencmd(command='rules', filters=Filters.chat_type.groups)
...
@queencmd(command='setrules', filters=Filters.chat_type.groups)
...
@queencmd(command='clearrules', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
