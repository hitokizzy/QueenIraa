...
from QueenIraa.modules.helper_funcs.chat_status import bot_admin, bot_can_delete

from QueenIraa.modules.helper_funcs.decorators import queencmd, queenmsg
from ..modules.helper_funcs.anonymous import user_admin, AdminPerms
import QueenIraa.modules.sql.antilinkedchannel_sql as sql


@queencmd(command="antilinkedchan", group=112)
@bot_can_delete
...
@queenmsg(Filters.is_automatic_forward, group=111)
...
@queencmd(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@queenmsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
