...
if is_module_loaded(FILENAME):
    ...
    from QueenIraa import GBAN_LOGS, log, dispatcher
    from QueenIraa.modules.helper_funcs.chat_status import user_admin as u_admin, is_user_admin
