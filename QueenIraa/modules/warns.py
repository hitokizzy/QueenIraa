...
def warn(
    ...
    if user.id in GEEZRAM_USERS:
        if warner:
            message.reply_text("GEEZRAMs cant be warned.")
        else:
            message.reply_text(
                "GEEZRAM triggered an auto warn filter!\n I can't warn GEEZRAMs but they should avoid abusing this."
            )
        return
