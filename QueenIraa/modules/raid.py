...
from .helper_funcs.decorators import queencmd, kigcallback
...
@queencmd(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@queencmd(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
