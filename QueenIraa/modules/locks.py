...
from QueenIraa import dispatcher, log
...
@queencmd(command='lock', pass_args=True)
...
@queencmd(command='unlock', pass_args=True)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
@typing_action
...
@queenmsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
