...
@queencmd(command='id', pass_args=True)
...
@queencmd(command='info', pass_args=True)
...
@queencmd(command='echo', pass_args=True, filters=Filters.chat_type.groups)
@user_admin
...
@queencmd(command='markdownhelp', filters=Filters.chat_type.private)
...
stats_str = '''
'''
@queencmd(command='stats', can_disable=False)
@sudo_plus
