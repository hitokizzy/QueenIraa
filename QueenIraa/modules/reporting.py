...
from QueenIraa import log, SUDO_USERS, GEEZRAM_USERS, WHITELIST_USERS
from QueenIraa.modules.helper_funcs.chat_status import user_not_admin
...
import QueenIraa.modules.sql.log_channel_sql as logsql
...
REPORT_GROUP = 12
REPORT_IMMUNE_USERS = SUDO_USERS + GEEZRAM_USERS + WHITELIST_USERS


@queencmd(command='reports')
...
@queencmd(command='report', filters=Filters.chat_type.groups, group=REPORT_GROUP)
@queenmsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
