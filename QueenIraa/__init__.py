...
log.info("[Queen Iraa] iraa is starting. | An Eagle Union Project. | Licensed under GPLv3.")
log.info("[Queen Iraa] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[Queen Iraa] Project maintained by: github.com/Dank-del (t.me/dank_as_fuck)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[Queen Iraa] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)

parser = ConfigParser()
parser.read("config.ini")
queenconfig = parser["queenconfig"]
...
class iraaINIT:
    def __init__(self, parser: ConfigParser):
        ...
        self.bot_name = "iraa" #placeholder
        self.bot_username = "iraaRobot" #placeholder
...
from QueenIraa.modules.helper_funcs.handlers import CustomCommandHandler
