...
H‌ٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖallo, saya adalah Geez/Ram Bot[!](https://telegra.ph/file/3b757c3986ec72f09096c.jpg)\nBot yang di buat oaleh cinta dan kasih sayang di GEEZ/RAM, info lebih lanjut silahkan ketik /help"
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Geez/Ram Online")
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(Fallen_about_callback, pattern=r"geezram_")
