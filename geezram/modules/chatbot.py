...
import html
import requests
import geezram.modules.sql.chatbot_sql as sql
...
from geezram.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from geezram import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Queen Robot Chatbot Disabled By {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Queen Robot Chatbot Enabled By {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
