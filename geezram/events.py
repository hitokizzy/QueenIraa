...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import geezram.events

        path = Path(f"geezram/modules/{shortname}.py")
        name = "geezram.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["geezram.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "geezram/modules/*.py"
